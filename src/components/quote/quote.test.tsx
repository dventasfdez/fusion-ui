...
test('render quote component and match snapshot', () => {
  const component = renderer.create(
    <QuoteTest>
      <QuoteText>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa commodi officiis optio magni! Perferendis doloremque
        similique quas magnam repellendus facere voluptatem tenetur possimus cupiditate rerum suscipit, accusamus ullam magni
        odio.
      </QuoteText>
    </QuoteTest>
  );
...
test('render quote component with avatar with span', () => {
  const {container} = render(
    <QuoteTest>
      <QuoteText>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa commodi officiis optio magni! Perferendis doloremque
