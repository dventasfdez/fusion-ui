  ...
  return (
    <div className="parent">
      ...
      <p data-testid="outside">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro expedita reiciendis iusto. Amet nam voluptatem rem
        officia voluptates! Officia molestiae placeat maiores at voluptates tempore cupiditate quos ratione, nesciunt sint.
      </p>
    </div>
  );
};
