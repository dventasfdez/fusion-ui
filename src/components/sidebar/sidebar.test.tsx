...
const sidebarExample = (props?: ISidebarProps | any) => (
  <Sidebar data-testid="sidebar" {...props} className="fusion-ui">
    ...
    <SidebarButton
      ...
      href="#1"
    />
    <SidebarButton data-testid="sidebar-button-2" id="button2" icon={<span className="material-icons">home</span>} label="Home" href="#2" />
    <SidebarButton data-testid="sidebar-button-3" id="button3" icon={<span className="material-icons">home</span>} label="Home" href="#3" />
    <SidebarButton data-testid="sidebar-button-4" id="button4" disabled icon={<span className="material-icons">home</span>} label="Home" href="#4" />
    <SidebarDivider data-testid="sidebar-divider">divider text</SidebarDivider>
    <SidebarButton data-testid="sidebar-button-5" id="button5" icon={<span className="material-icons">home</span>} label="Home" href="#5" />
    <SidebarButton data-testid="sidebar-button-6" id="button6" icon={<span className="material-icons">home</span>} label="Home" href="#6" />
    <SidebarButton data-testid="sidebar-button-7" id="button7" icon={<span className="material-icons">home</span>} label="Home" href="#7" />
    <SidebarButton data-testid="sidebar-button-8" id="button8" icon={<span className="material-icons">home</span>} label="Home" href="#8" />
    <SidebarButton data-testid="sidebar-button-9" id="button9" icon={<span className="material-icons">home</span>} label="Home" href="#12" />
    <SidebarButton data-testid="sidebar-button-10" id="button10" icon={<span className="material-icons">home</span>} label="Home" href="#123" />
    <SidebarButton data-testid="sidebar-button-11" id="button11" icon={<span className="material-icons">home</span>} label="Home" href="#145" />
  </Sidebar>
);
