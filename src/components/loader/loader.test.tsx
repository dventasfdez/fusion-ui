...
it("render loader automatically", () => {
  jest.useFakeTimers();
  const { getByTestId } = render(<LoaderExample title="Test Title" subtitle="Test subtitle" automatic percentage={{ show: true }} />);
  const loader = getByTestId("loader-test-svg-container");
...
describe("finish loading both cases", () => {
  ...
  it("success case with percentages", async () => {
    const { getByTestId } = render(<LoaderExample title="Test Title" subtitle="Test subtitle" success automatic percentage={{ show: true }} />);
    const loader = getByTestId("loader-test-svg-container");
    act(() => {
      jest.advanceTimersByTime(6000);
    });
  ...
  it("error case with percentages", async () => {
    const { getByTestId } = render(<LoaderExample title="Test Title" error subtitle="Test subtitle" automatic percentage={{ show: true }} />);
    const loader = getByTestId("loader-test-svg-container");
