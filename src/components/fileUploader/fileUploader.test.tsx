...
test('File Uploader should render', () => {
  ...
  const component = renderer.create(
    fileUploaderExample({formats: 'application/pdf', max: 1, onChange: onChangeMock, 'data-testid': 'file-uploader'})
  );
  const tree = component.toJSON();
  expect(tree).toMatchSnapshot();
});

test('File Uploader with label should render', () => {
  const onChangeMock = jest.fn((files?: File[]) => files);
  const component = renderer.create(
    fileUploaderExample({
...
test('File Uploader should render without test id', () => {
  const onChangeMock = jest.fn((files?: File[]) => files);
...
test('File Uploader drag and drop with label should render', () => {
  const onChangeMock = jest.fn((files?: File[]) => files);
  const component = renderer.create(
    fileUploaderExample({
      formats: 'application/pdf',
...
test('File Uploader drag and drop should render without test id', () => {
  const onChangeMock = jest.fn((files?: File[]) => files);
  const component = renderer.create(
...
test('File Uploader small with label should render', () => {
  const onChangeMock = jest.fn((files?: File[]) => files);
  const component = renderer.create(
    fileUploaderExample({
      formats: 'application/pdf',
...
test('File Uploader small should render without test id', () => {
  const onChangeMock = jest.fn((files?: File[]) => files);
  const component = renderer.create(
...
test('File Uploader full width with label should render', () => {
  const onChangeMock = jest.fn((files?: File[]) => files);
  const component = renderer.create(
    fileUploaderExample({
      formats: 'application/pdf',
...
test('File Uploader full width should render without test id', () => {
  const onChangeMock = jest.fn((files?: File[]) => files);
  const component = renderer.create(
...
test('File Uploader drag and drop with label full should render', () => {
  const onChangeMock = jest.fn((files?: File[]) => files);
  const component = renderer.create(
    fileUploaderExample({
      formats: 'application/pdf',
...
test('File Uploader drag and drop full should render without test id', () => {
  const onChangeMock = jest.fn((files?: File[]) => files);
  const component = renderer.create(
...
test('Single File uploader with value and secondary button', () => {
  const onChangeMock = jest.fn((files?: File[]) => files);
  ...
  const {container} = render(
    fileUploaderExample({formats: 'application/pdf', max: 1, onChange: onChangeMock, value: fileVal, secondary: true})
  );
...
test('Single File uploader with value with error', () => {
  const onChangeMock = jest.fn((files?: File[]) => files);
...
test('Single File uploader with value loading', () => {
  const onChangeMock = jest.fn((files?: File[]) => files);
...
test('Single File uploader with value disabled', () => {
  const onChangeMock = jest.fn((files?: File[]) => files);
  ...
  const fileVal: IFile = {loading: false, error: 'error', file: file};
  const {container} = render(
    fileUploaderExample({formats: 'application/pdf', max: 1, onChange: onChangeMock, value: fileVal, disabled: true})
  );
...
test('Multiple File uploader with value with error', () => {
  const onChangeMock = jest.fn((files?: File[]) => files);
...
test('Multiple File uploader with value with loading', () => {
  const onChangeMock = jest.fn((files?: File[]) => files);
...
test('Multiple File uploader with value disabled', () => {
  const onChangeMock = jest.fn((files?: File[]) => files);
