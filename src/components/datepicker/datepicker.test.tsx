...
describe('Tests of simple datepicker', () => {
  test('render simple datepicker without data-testid', () => {
  ...
  test('render simple datepicker with error', () => {
    const {container} = render(
      datePickerExample({
        name: 'datepicker-simple',
  ...
  test('render simple datepicker disabled', () => {
    const {container} = render(
      datePickerExample({
        name: 'datepicker-simple',
        'data-testid': 'datepicker',
  ...
  test('Write date today in input simple datepicker and call onChange', () => {
    const onChange = jest.fn();
    const {getByTestId} = render(
      datePickerExample({name: 'datepicker-simple', 'data-testid': 'datepicker', mode: DatePickerMode.SINGLE, onChange})
    );
...
describe('Tests of multiple datepicker', () => {
  test('render multiple datepicker without data-testid', () => {
    const {container} = render(
      datePickerExample({
        label: 'label',
        required: true,
  ...
  test('render multiple datepicker with error', () => {
    const {container} = render(
      datePickerExample({
        name: 'datepicker-multiple',
        'data-testid': 'datepicker',
  ...
  test('render multiple datepicker disabled', () => {
    const {container} = render(
      datePickerExample({
        name: 'datepicker-multiple',
        'data-testid': 'datepicker',
  ...
  test('Write two dates with error in input multiple datepicker and clean dates in input', () => {
    const {container, getByTestId} = render(
      datePickerExample({name: 'datepicker-multiple', 'data-testid': 'datepicker', mode: DatePickerMode.MULTIPLE})
    );
...
describe('Tests of range datepicker', () => {
  test('render range datepicker without data-testid', () => {
    const {container} = render(
      datePickerExample({
        name: 'datepicker-multiple',
  ...
  test('render range datepicker with values', () => {
    const {getByTestId} = render(
      datePickerExample({
  ...
  test('render range datepicker with error', () => {
    const {container} = render(
      datePickerExample({
        name: 'datepicker-simple',
        'data-testid': 'datepicker',
  ...
  test('Select options and unselect start date in range datepicker', () => {
    const {container, getByTestId} = render(
      datePickerExample({name: 'datepicker-simple', 'data-testid': 'datepicker', mode: DatePickerMode.RANGE})
    );
  ...
  test('Select options and unselect end date in range datepicker', () => {
    const {container, getByTestId} = render(
      datePickerExample({name: 'datepicker-simple', 'data-testid': 'datepicker', mode: DatePickerMode.RANGE})
    );
  ...
  test('Select options and select another date in range datepicker', () => {
    const {container, getByTestId} = render(
      datePickerExample({name: 'datepicker-simple', 'data-testid': 'datepicker', mode: DatePickerMode.RANGE})
    );
  ...
  test('Select start date and unselect date in range datepicker', () => {
    const {container, getByTestId} = render(
      datePickerExample({name: 'datepicker-simple', 'data-testid': 'datepicker', mode: DatePickerMode.RANGE})
    );
  ...
  test('Write date end and start with error and clean inputs in datepicker range', () => {
    const {container, getByTestId} = render(
      datePickerExample({name: 'datepicker-multiple', 'data-testid': 'datepicker', mode: DatePickerMode.RANGE})
    );
